"""
Training script for GOAT model.

Usage:
    python experiments/train_goat.py --config configs/goat_molhiv.yaml
    python experiments/train_goat.py --config configs/goat_zinc.yaml
"""
...
def create_model(config: ExperimentConfig) -> GOAT:
    """Create GOAT model from config"""
    ...
    model = GOAT(
        ...
        num_virtual_nodes=model_cfg.num_virtual_nodes,
...
def main():
    parser = argparse.ArgumentParser(description="Train GOAT model")
